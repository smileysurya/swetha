...
const CONFIG = {
  ...
  loveLetter: `i want to make an apllication like a happy 5th year anniversary and add some pictures of their memories photo so i want to develop the application in antigravity so the contents are when i click the link it should open and pop up with blue heart and with name of pradeep swetha and when i click the heart it goes to another page happy 5th love anniversary and when we scroll up its should show the days of love so the days of love is aug 13 202 to aug 13 2026 its should shows like years,days, hours, minutes, seconds and when i scroll up it should show the cherished memories like photos and a small note a love like happy 5th love anniversary my love. thankyou so much indga love la enakaga ivolo love, support, affection, elame kudutha  the love jounery un kuda romba azhaga iru, life long idhe care and love will be there and indha life la enaku kedaicha tresurre nee teddy. life la evolo prblems vandhalu na irupan epome un side enakaga indha life ha kuduthadhuku thanks you so much mu.. love you always teddy happy love anniversary so this is the content of the note in a small box and the application theme should be in white and light bluse and the blue hearts should be comes like rain drops as per this request give me the code file to build the application.`,
  quotes: [
